...
| Poland  | PL  | No prescription required, but sold as a registered OTC _medicine_ (up to 5mg), not a free-sale supplement — closest of the EU countries surveyed to the US model, but still a distinct regime.                        | Medium-high |
