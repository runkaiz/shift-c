...
{#if shouldShow}
	...
	>
		<p>
			{$_('learn.circadian.intro')}
		</p>
		<p class="pt-4">
			{$_('learn.circadian.biologicalClock')}
		</p>
		<p class="pt-4">
			{$_('learn.circadian.sleepPressure')}
		</p>
		<p class="pt-4">
			{$_('learn.circadian.batteryAnalogy')}
		</p>
		<p class="pt-4">
			{$_('learn.circadian.adjustment')}
		</p>
	</div>
